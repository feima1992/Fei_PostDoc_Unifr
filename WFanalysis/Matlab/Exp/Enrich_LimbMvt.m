classdef Enrich_LimbMvt < Enrich
    
    properties
        dataFilter = {'WFW_M', 'TrialAll', 'MvtDir0'};
        expInfo = 'WF-CranialWindow';
    end
    
    methods
        function obj = Enrich_LimbMvt()
            obj = obj@Enrich();
            obj.LoadIMcorr();
        end
        ...
        function obj = LoadIMcorr(obj)
            ...
            if exist(fullfile(obj.resultPath, 'Enrich_LimbMvt_ActIMcorr.mat'), "file")
                ...
                load(fullfile(obj.resultPath, 'Enrich_LimbMvt_ActIMcorr.mat'), 'objFileTableActReg');
        ...
        function obj = PlotActMap(obj, actMapThre)
            ...
            saveas(obj.figActMap, fullfile(obj.resultPath, ['Enrich_LimbMvt_ActMap_', num2str(obj.actMapThre), '.svg']));
        ...
        function obj = PlotActEdge(obj, actMapThre)
            ...
            saveas(obj.figActEdge, fullfile(obj.resultPath, ['Enrich_LimbMvt_ActEdge_', num2str(obj.actMapThre), '.svg']));
        ...
        function obj = ExportActProps(obj, actMapThre)
            ...
            writetable(obj.objRegIMcorrCopy.fileTable, fullfile(obj.resultPath, ['Enrich_LimbMvt_ActProps_', num2str(obj.actMapThre), '.csv']));
        end
