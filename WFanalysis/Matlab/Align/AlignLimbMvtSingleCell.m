    ...
    methods
        ...
        function obj = AlignWfBpod(obj)
            ...
            for i = 1:max(groupIdx)
                ...
                csvFile = fullfile("D:\Data\SingleCellData", [thisSession.mouse{1}, '_', thisSession.session{1}, '.csv']);
                ...
                tiffCombined = fullfile("D:\Data\SingleCellData", [thisSession.mouse{1}, '_', thisSession.session{1}, '.tif']);
